package com.example.LT_Nhom9_Java_Buoi7.controller;

import com.example.LT_Nhom9_Java_Buoi7.entity.Product;
import com.example.LT_Nhom9_Java_Buoi7.services.CategoryService;
import com.example.LT_Nhom9_Java_Buoi7.services.ProductService;
...
public class AdminProductController {
                       ...
                       Model model)
    {
        ...
        {
            try {
                File saveFile = new ClassPathResource("static/images").getFile();Path path = Paths.get(saveFile.getAbsolutePath() + File.separator +
